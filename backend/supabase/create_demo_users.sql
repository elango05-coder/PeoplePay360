...
INSERT INTO auth.users (
    ...
    ('00000000-0000-0000-0000-000000000000', '10000000-0000-0000-0000-000000000001', 'authenticated', 'authenticated', 'admin@peoplepay360.com', crypt('Password123!', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"System Administrator","role":"admin"}', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000000', '10000000-0000-0000-0000-000000000002', 'authenticated', 'authenticated', 'hr.manager@peoplepay360.com', crypt('Password123!', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"HR Manager","role":"hr_manager"}', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000000', '10000000-0000-0000-0000-000000000003', 'authenticated', 'authenticated', 'payroll.user@peoplepay360.com', crypt('Password123!', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"HR Payroll User","role":"hr_payroll_user"}', NOW(), NOW()),
    ('00000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000004', 'authenticated', 'authenticated', 'payroll.manager@peoplepay360.com', crypt('Password123!', gen_salt('bf')), NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"HR Payroll Manager","role":"hr_payroll_manager"}', NOW(), NOW()),
...
VALUES
    ('10000000-0000-0000-0000-000000000001', 'admin@peoplepay360.com', 'System Administrator', 'admin', NULL, true),
    ('10000000-0000-0000-0000-000000000002', 'hr.manager@peoplepay360.com', 'HR Manager', 'hr_manager', NULL, true),
    ('10000000-0000-0000-0000-000000000003', 'payroll.user@peoplepay360.com', 'HR Payroll User', 'hr_payroll_user', NULL, true),
    ('10000000-0000-0000-0000-000000000004', 'payroll.manager@peoplepay360.com', 'HR Payroll Manager', 'hr_payroll_manager', NULL, true),
